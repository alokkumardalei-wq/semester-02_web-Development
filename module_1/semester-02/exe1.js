...
function assignDelivery(orderStatus) {
  ...
  return new Promise((resolve,reject)=>{
    ...
    resolve("Delivery Partener Assigned");
  })
}
...
// WRITE YOUR CODE HERE
checkRestaurantStatus().then(value=>{console.log("Restaurant is open");return getMenu()})
                       .then(value=>{ console.log("Menu fetched:"); return placeOrder("burger")})
                       .then(value=>{console.log("Order Placed");return assignDelivery("600")})
                       .then(value=>{console.log("Delivery Partner Assigned")})
...
checkRestaurantStatus()
  ...
  .then(()=>console.log("Cash on Delivery Selected"))
  .then(()=>console.log("Continue Delivery assignment"));
...
*/
  ...
  // WRITE YOUR CODE HERE
makePayment().catch(err=>{console.log("Cash on Delivery Selected")}).then((val=> {console.log("Continue Delivery Payment")}));
